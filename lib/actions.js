                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                ...
                                return _context.abrupt("return", dispatch(SUCCESS(response.status, response.data)));

                            case 8:
                                _context.prev = 8;
                                _context.t0 = _context["catch"](1);
                                return _context.abrupt("return", dispatch(FAILURE(_context.t0.response.status, _context.t0.response.data)));
...
function getGroup(resource, action) {
    ...
    return _ref2 = {}, _defineProperty(_ref2, action + "_REQUEST", resource + "_" + action + "_REQUEST"), _defineProperty(_ref2, funcName + "Request", function undefined(payload) {
        ...
        return {
            ...
            payload: { statusCode: statusCode, data: data },
            error: true
        };
    }), _ref2;
}
