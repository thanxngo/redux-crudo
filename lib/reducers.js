                ...
                case actions.UPDATE_REQUEST:
                    {
                        ...
                        if (id && state.items && state.items.has(id)) {
                            ...
                            newItem = _extends({}, item, payload.data);
                            newItems = (0, _immutabilityHelper2.default)(state.items, _defineProperty({}, id, { $set: newItem }));
                        }
                        if (state.item) {
                            // Update current item
                            newItem = _extends({}, state.item, payload.data);
                        }
                        return _extends({}, state, noErrorsState, {
                            item: newItem || {},
                            items: newItems,
